...
// ung mga csv path file wag kalimutan ibahin
// STRUCT HELPER NG EMCEE AT PHOTOBOOTH PARA SA CSV MANIPULATION (ps: pwede rin sama dito ung bang struct na nasa ilalim ko na implement)
struct Emcee {
    string name;
    double rate;
};
...
{
    const string filename = "C:\\Users\\Axel Carl Nadera\\Desktop\\CP1-project\\Catering_package.csv";
...
// STRUCT HELPER SA MENU ITEMS FOR CSV
...
void ManageCateringItems()
{
    const string filename = "C:\\Users\\Axel Carl Nadera\\Desktop\\CP1-project\\CATERING_Menu.csv";
